...
@st.cache_data
def load_data():
    df_a = pd.read_parquet("Data/gestiones_dashboard_pasiva.parquet")
    df_b = pd.read_parquet("Data/gestiones_comparacion_pasiva.parquet")
